<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        <li class="<?php echo basename($_SERVER['PHP_SELF']) == 'services_report.php' ? 'active' : ''; ?>">
            <a href="services_report.php"><i class="material-icons pb-3">description</i><span>Service Report</span></a>
        </li>
