                        ...
                        return `<tr>
                                    ...
                                    <td>
                                        <span class='d-inline-flex'>
                                            <a href='#' class='edit-part mr-2' data-id='${part.part_id}' data-toggle='modal' data-target='#editPartModal' title='EditParts'>
                                                <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                            </a>
                                            <a href="#" class="archive-part mr-2" data-id="${part.part_id}" data-toggle="modal" data-target="#deletePartModal" title='DeleteParts'>
