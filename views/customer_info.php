...
<head>
    ...
    <style>
        ...
        /* Fix modal scrollbar shift issue */
        body.modal-open {
        ...
        /* Additional fix for scrollbar compensation */
        .modal-open {
            padding-right: 0 !important;
        }
                                    ...
                                    <form method="post" id="deleteCustomerForm">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                ...
                                                <strong>Warning:</strong> This will permanently delete the customer and ALL their appliances from the system.
                                            </div>
                                            <p>Are you sure you want to archive this customer and all their appliances?</p>
                                            <p class="text-muted"><small>This action cannot be undone. All data will be moved to the archive.</small></p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response && response.success) {
                            ...
                            loadCustomers();
                            showAlert('success', 'Customer and all appliances archived successfully');
                        } else {
                            alert('Error: ' + response.message);
                        }
                    },
